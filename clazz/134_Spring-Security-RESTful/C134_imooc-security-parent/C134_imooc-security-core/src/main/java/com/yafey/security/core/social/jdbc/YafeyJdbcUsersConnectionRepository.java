 ...
 * @author Keith Donald
 */
public class YafeyJdbcUsersConnectionRepository implements UsersConnectionRepository {
	...
	public YafeyJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
